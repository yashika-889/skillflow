...
import "@/lib/flow.js"; // Import FCL config
...
export default function Sidebar() {
  ...
  // --- 1. ADDED: Get the real user from FCL ---
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-800/50 backdrop-blur-lg border-r border-neutral-700/50">
      ...
      {/* --- 2. UPDATED: Logo is now a Link to Home --- */}
      ...
      <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        ...
        {/* --- 3. UPDATED: Avatar & Name link to profile and are dynamic --- */}
